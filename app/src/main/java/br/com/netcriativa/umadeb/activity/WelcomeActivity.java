...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Verificando o primeiro lançamento - antes de chamar setContentView ()
        ...
        // Layouts de todos os sliders de boas-vindas
        // adicione mais alguns layouts se você quiser
        layouts = new int[]{
